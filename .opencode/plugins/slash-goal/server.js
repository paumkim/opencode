...
class StateReadError extends Schema.TaggedErrorClass()("StateReadError", {
  cause: Schema.Unknown
}) {
}

class StateDecodeError extends Schema.TaggedErrorClass()("StateDecodeError", {
  cause: Schema.Unknown
}) {
}

class StateWriteError extends Schema.TaggedErrorClass()("StateWriteError", {
  cause: Schema.Unknown
}) {
}
...
var GoalSchema = Schema.Struct({
  ...
  completionEvidence: Schema.optional(NullableString),
  blocker: Schema.optional(NullableString),
  closedAt: Schema.optional(NullableNumber),
  ...
  lastStatus: Schema.optional(NullableString),
  maxAutoTurns: Schema.optional(NullableNumber),
  maxDurationSeconds: Schema.optional(NullableNumber),
  noProgressTokenThreshold: Schema.optional(NullableNumber),
  maxNoProgressTurns: Schema.optional(NullableNumber),
  noProgressTurns: Schema.optional(Schema.Number),
  budgetWrapupSent: Schema.optional(Schema.Boolean),
  stopReason: Schema.optional(NullableString),
  ...
  lastPromptAgent: Schema.optional(NullableString),
...
function decodeState(value) {
  return Schema.decodeUnknownEffect(StateSchema)(value).pipe(Effect.map(mutableState), Effect.map(normalizeState), Effect.mapError((cause) => new StateDecodeError({ cause })));
}

  ...
  describe("latest", () => {
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("paumkim/tap/opencode")) return ""
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("paumkim/tap/opencode") && args.includes("--formula")) return "opencode"
